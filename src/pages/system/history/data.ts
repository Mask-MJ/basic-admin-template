...
export const historyColumns = ({
  ...
  return [
    ...
    { title: '创建者', key: 'creator' },
    {
      ...
      align: 'center',
      render(row) {
        return h(NButton, { type: 'primary', onClick: () => action(row) }, () => '查看');
      },
    },
  ];
};
...
export const historyData: History[] = [
  { no: 1, create_time: '2021-08-01 12:00:00', creator: 'admin' },
  { no: 2, create_time: '2021-08-02 12:00:00', creator: 'admin' },
  { no: 3, create_time: '2021-08-03 12:00:00', creator: 'admin' },
  { no: 4, create_time: '2021-08-04 12:00:00', creator: 'admin' },
  { no: 5, create_time: '2021-08-05 12:00:00', creator: 'admin' },
  { no: 6, create_time: '2021-08-06 12:00:00', creator: 'admin' },
  { no: 7, create_time: '2021-08-07 12:00:00', creator: 'admin' },
  { no: 8, create_time: '2021-08-08 12:00:00', creator: 'admin' },
  { no: 9, create_time: '2021-08-09 12:00:00', creator: 'admin' },
  { no: 10, create_time: '2021-08-10 12:00:00', creator: 'admin' },
  { no: 11, create_time: '2021-08-11 12:00:00', creator: 'admin' },
  { no: 12, create_time: '2021-08-12 12:00:00', creator: 'admin' },
  { no: 13, create_time: '2021-08-13 12:00:00', creator: 'admin' },
  { no: 14, create_time: '2021-08-14 12:00:00', creator: 'admin' },
  { no: 15, create_time: '2021-08-15 12:00:00', creator: 'admin' },
  { no: 16, create_time: '2021-08-16 12:00:00', creator: 'admin' },
  { no: 17, create_time: '2021-08-17 12:00:00', creator: 'admin' },
  { no: 18, create_time: '2021-08-18 12:00:00', creator: 'admin' },
  { no: 19, create_time: '2021-08-19 12:00:00', creator: 'admin' },
  { no: 20, create_time: '2021-08-20 12:00:00', creator: 'admin' },
  { no: 21, create_time: '2021-08-21 12:00:00', creator: 'admin' },
  { no: 22, create_time: '2021-08-22 12:00:00', creator: 'admin' },
  { no: 23, create_time: '2021-08-23 12:00:00', creator: 'admin' },
];
